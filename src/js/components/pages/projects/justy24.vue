        ...
        <div class="container mx-auto project-page">
            <div class="subsection">
                ...
                <div class="content">
                    ...
                    <p>Users could then find nearby restaurants, place an order from the menu and set a time of arrival (reserve a table essentially). The restaurants would then pick those orders up, confirm or reject them and get started with the preparation of the meals that have already been paid for through the app.</p>
                </div>
            </div>
            <div class="subsection">
                <div class="content">
